...
public class Menu_final extends JFrame {
	 ...
	 */
	public Menu_final() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Menu_final.class.getResource("/Menu_img/artificial-intelligence.png")));
		...
		//vu que la frame est Undecorated on a besoin de ces MouseListeners pour la faire bouger(frame)
		  addMouseListener(new MouseAdapter() {
			...
			btnchooser.setIcon(new ImageIcon(Menu_final.class.getResource("/Datasets_img/folder.png")));
		...
		BGMenu.setIcon(new ImageIcon(Menu_final.class.getResource("/Menu_img/BG-1.png")));	// Back ground de base	
...
// Bouton Reduire ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		Minimise_BTN.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				Minimise_BTN.setIcon(new ImageIcon(Menu_final.class.getResource("/Menu_img/Minimize ML selected.png")));
			}
			@Override
			public void mouseExited(MouseEvent e) {
				Minimise_BTN.setIcon(new ImageIcon(Menu_final.class.getResource("/Menu_img/Minimize ML .png")));
			}
		});
...
// Exit bouton//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		Exit_BTN.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent arg0) {
				Exit_BTN.setIcon(new ImageIcon(Menu_final.class.getResource("/Menu_img/Exit ML selected.png")));
			}
			@Override
			public void mouseExited(MouseEvent arg0) {
				Exit_BTN.setIcon(new ImageIcon(Menu_final.class.getResource("/Menu_img/Exit ML.png")));
			}
		});
...
//Boutton 
		...
		btnHome.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				if (btnHome.isEnabled()) {
					btnHome.setIcon(new ImageIcon(Menu_final.class.getResource("/Models_img/home selected.png")));//changer les couleurs button
				}
			}
			@Override
			public void mouseExited(MouseEvent e) {
				if (btnHome.isEnabled()) {
					btnHome.setIcon(new ImageIcon(Menu_final.class.getResource("/Models_img/home.png")));//remetre le bouton de base
				}
			}
		});
		btnHome.setIcon(new ImageIcon(Menu_final.class.getResource("/Models_img/home.png")));
		...
		textFieldNBR.setText("1 , 2 ...");
		textFieldNBR.setForeground(Color.ORANGE);
		...
		textFieldD.setForeground(Color.ORANGE);
		...
		Search.setIcon(new ImageIcon(Menu_final.class.getResource("/Menu_img/search 1.png")));
		Search.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent arg0) {
				Search.setIcon(new ImageIcon(Menu_final.class.getResource("/Menu_img/search 2.png")));
			}
			@Override
			public void mouseExited(MouseEvent e) {
				Search.setIcon(new ImageIcon(Menu_final.class.getResource("/Menu_img/search 1.png")));
		...
		Search.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				if(!File_Selected.equals("C:/Users/name/Desktop/..."))
				{
					...
					Float t=(float) 2;
					if(textFieldD.getText().equals("1 , 2 ...")) {
						 t=(float) 0.2;
					}
					else {
					 t=Float.parseFloat(textFieldD.getText().toString());
					}
					if(t>=0 && t<=1 )
					{
					  ...
					  JFrame f = new JFrame("Stepping Progress");
						...
						Docanimation1_1.setIcon(new ImageIcon(Menu.class.getResource("/Menu_img/Magnify-0.9s-114px.gif")));//animation de base
						Docanimation1_1.setBounds(250, 50, 114, 114);
						 f.getContentPane().add(Docanimation1_1);
						...
						Thread t1 = new Thread(){
						    public void run(){
									...
									if(textFieldD.getText().equals("1 , 2 ...")) {
										 ...
										 d =textFieldD.getText();
									}
									String nbr =textFieldNBR.getText();
									if(textFieldNBR.getText().equals("1 , 2 ...")) {
										 nbr= "10";
									}
									else {
										 nbr =textFieldNBR.getText();
									}
									String path_script ="";
									  ...
									  pb = new ProcessBuilder("python",path_script,"--path_image",Path ,"--distance",d,"--nbr",nbr ).inheritIO();
										...
										if(!stopped) {
											...
											if (test.equals("VOITURE TROUVEE ! ")) {
												JOptionPane.showMessageDialog(null,  "Accés non autorisé.","state" ,JOptionPane.PLAIN_MESSAGE, new ImageIcon(Menu.class.getResource("/state/error.png")));	
											}
											else {
												if (test.equals("VOITURE NON TROUVEE ! ")) {
													JOptionPane.showMessageDialog(null,  "Accés autorisé.","state" ,JOptionPane.PLAIN_MESSAGE, new ImageIcon(Menu.class.getResource("/state/stamp.png")));	
													Step2 frame = new Step2(Path);
													frame.setLocationRelativeTo(contentPane);
													frame.setVisible(true);
												}
												else {
													JOptionPane.showMessageDialog(null,  "Accés autorisé(aucun vehicule black listée).","state" ,JOptionPane.PLAIN_MESSAGE, new ImageIcon(Menu.class.getResource("/state/stamp.png")));	
													Step2 frame = new Step2(Path);
													frame.setLocationRelativeTo(contentPane);
													frame.setVisible(true);
												}
							                	...
							                	f.dispose();
												JOptionPane.showMessageDialog(null,  "Stopped treatment.","state" ,JOptionPane.PLAIN_MESSAGE, new ImageIcon(Menu_final.class.getResource("/state/error.png")));	
												stopped=false;
							                }
					...
					Thread t2 = new Thread(){
					    public void run(){
					        ...
					        btnStop.setBounds(250, 140, 100, 25);
					...
					// and all threads will start to do stuff!
						...
						JOptionPane.showMessageDialog(null,  "Please make sure that the value of the distance is between 0 and 1 !","Warning" ,JOptionPane.PLAIN_MESSAGE, new ImageIcon(Menu_final.class.getResource("/state/error.png")));	
		...
		Search_1.setIcon(new ImageIcon(Menu_final.class.getResource("/Menu_img/license 1.png")));
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler " + "C:/Users/LATITUDE/Desktop/Bureau/dev/CV_PROJECT/bin/scripts_py/DATASET MAT/");
		             ...
		             Logger.getLogger(Menu_final.class.getName()).log(Level.SEVERE, null, ex);
				}
			}
		});
		Search_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent arg0) {
				Search_1.setIcon(new ImageIcon(Menu_final.class.getResource("/Menu_img/license 2.png")));
		...
		Search_1.setToolTipText("la liste des voitures black listées");
